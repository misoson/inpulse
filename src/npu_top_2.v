...
//=============================================================================
// File        : npu_top.v
// Description : Optimized top module for Gated Convolution NPU (Integrated Version)
//=============================================================================
...
module npu_top #(
    ...
    //======================================================================
    // Feature Weight Buffer Wires (보존)
    //======================================================================
    ...
    //=========================================================================
    // 3. Shared Line Buffer (제어 정합 수정)
    //=========================================================================

    wire lbuf_stream_enable;

    // [수정] 외부 유효 신호와 컨트롤러의 리드 활성화 신호를 정밀 논리곱 결합
    ...
    // [수정] 컨트롤러의 레이턴시 보정 유효 신호(in_valid_ctrl)가 직접 입력단을 전담 제어하도록 맵핑 변경
    ...
    //=========================================================================
    // Weight Buffers (Feature & Gate) (보존)
    //=========================================================================
    ...
    fsm_controller #(
        ...
        // [수정] 대표 포트 0번만 단순 매핑해 연산 흐름이 끊기지 않도록 전체 Array의 Valid 출력 반영
    ...
    //=========================================================================
    // 7. PE output to Activation input conversion (보존)
    //=========================================================================
